  ...
  return (
   <>
    <header className="fmo--nav bg-[#FFFFFF] w-full h-auto py-4 lg:py-2 z-50 relative" style={{ fontFamily: 'Aeroport, sans-serif' }}>
      ...
      <nav id='xs--sm--md--devices-nav' className={`nab--mobile--tablet absolute bg-white py-4 flex flex-col justify-between w-5/6 xl:hidden top-0 left-0 z-50 transform transition-transform duration-500 min-h-[100dvh] ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
