    ...
    return(
        <div 
            ...
            <div className="parkingform">
                <form className="my-5">
                 <div className="form-header-beginn"><span className="text-sm universal-txt">Parkbeginn</span></div>
               ...
               <a 
                href="" 
                className='text-white w-full text-md rounded-md cursor-pointer bg-[#002844] text-center px-6 py-4'
                >
                Parkplatz buchen
                </a>
               </div>
